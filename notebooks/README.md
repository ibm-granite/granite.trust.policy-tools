...
In this tutorial, we demonstrate how to use [ARES](https://github.com/IBM/ares) (AI Robustness Evaluation System) to red-team LLMs using harmful prompts generated by [fms-dgt](https://github.com/IBM/fms-dgt) and how to evaluate the resulting model responses against the same policy using ARES `PolicyEval`. See the complete walkthrough in [link](../notebooks/red_team_models_with_ares.ipynb)